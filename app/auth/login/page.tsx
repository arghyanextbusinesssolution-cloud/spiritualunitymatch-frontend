      ...
      <main className="relative pt-20 pb-10 px-margin-mobile md:px-margin-desktop flex flex-col items-center justify-center min-h-screen overflow-hidden">
        ...
        >
          <div className="text-center mb-6">
            <h1 className="font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface mb-2">Welcome Back</h1>
            <p className="font-body-md text-body-md text-on-surface-variant">Please enter your login details below.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="text-right mt-1.5">
                <Link href="#" className="font-label-caps text-[9px] text-primary font-bold hover:underline">
            ...
            <p className="text-center font-label-caps text-[9px] leading-relaxed text-on-surface-variant mt-2">
              Don't have an account? <Link href="/auth/register" onClick={() => startLoading()} className="text-primary font-bold hover:underline">Register Now</Link>
            </p>
          </form>
        </motion.div>
      </main>
